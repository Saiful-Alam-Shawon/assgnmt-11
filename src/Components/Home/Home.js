...
import img2 from '../../img/baner2.jpg'
        ...
        <div >
            ...
            <div>
                ...
                <div className='grid grid-cols-3 gap-4'>
                    ...
                    {
                        service3.map(service => <Services key={service._id} service={service}></Services>)
                    }
                </div>
            ...
            <section className="py-10 dark:bg-gray-800 dark:text-gray-100">
                <div className="container px-4 mx-auto">
                    ...
                    <div className="flex flex-wrap items-stretch -mx-4">
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 bg-gray-400 rounded-xl ">
                            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                                ...
                                <button type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded dark:bg-violet-400 dark:text-gray-900 btn btn-primary">Get Started</button>
                            </div>
                        </div>
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 bg-gray-400 rounded-xl">
                            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-400 dark:text-gray-900">
                                ...
                                <a rel="noopener noreferrer" href="# " className="inline-block w-full px-5 py-3 font-bold tracking-wider text-center rounded dark:bg-gray-800 dark:text-violet-400 btn btn-primary">Get Started</a>
                            </div>
                        </div>
                        <div className="w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 bg-gray-400 rounded-xl">
                            <div className="p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                                ...
                                <a rel="noopener noreferrer" href="# " className="inline-block w-full px-5 py-3 font-semibold tracking-wider text-center rounded dark:bg-violet-400 dark:text-gray-900 btn btn-primary">Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className='grid grid-cols-3 gap-6 mb-10'>
                    <button className="btn btn-primary">EMERGENCY PLUMBER</button>
                    <button className="btn btn-primary">DRAIN CLEANING</button>
                    <button className="btn btn-primary">TOILET REPAIR</button>
                    <button className="btn btn-primary">SEWEAR LINE </button>
                    <button className="btn btn-primary">FAUCAT REPAIR</button>
                    <button className="btn btn-primary">SINK REPAIR</button>
                    <button className="btn btn-primary">SINK REPAIR</button>
                    <button className="btn btn-primary">DRAIN CLEANING</button>
                    <button className="btn btn-primary">SEWAER REPAIR</button>
